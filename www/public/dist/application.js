...
var ApplicationConfiguration = (function() {
	...
	var applicationModuleName = 'notifier';
...
// Use applicaion configuration module to register a new module
ApplicationConfiguration.registerModule('notifiers');
'use strict';
...
//Setting up route
angular.module('notifiers').config(['$stateProvider',
	function($stateProvider) {
		// Notifiers state routing
		$stateProvider.
		state('notifierProfile', {
			url: '/notifiers',
			templateUrl: 'modules/notifiers/views/notifier.client.view.html',
			controller: 'NotifiersController'
		});
	}
]);
...
//Notifiers service used to communicate Notifiers REST endpoints
angular.module('notifiers').factory('Notifiers', ['$resource',
	function($resource) {
	...
	function($scope, $http, $location, Authentication) {
		...
		$scope.signup = function() {
			$http.post('/auth/signup', $scope.credentials).success(function(response) {
				...
				$location.path('/settings/view/profile');
